...
infile<-"/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06.2-U-bias-family/raw-quasi/quasi-forr.r"
t<-read.table(infile)
# R1-G1	QUASIMODO	piRNA	se	P	8316	A,C,T,G
...
infile<-paste0("/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06.2-U-bias-family/graph/quasi_",active_smtype,"_",active_strand,".pdf")  
plot(p)
...
t<-read.table(infile)
names(t)<-c("sid","te","smtype","strand","quatsch","coverage","order","matrix")
t<-subset(t,te=="QUASIMODO" & smtype=="piRNA" & sid %in% c("R1-G30","R2-G30","R4-G30"))
...
plot(p)
pdf(file="/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06.2-U-bias-family/graph/quasi_main_g30.pdf",width=7,height=4)
plot(p)
dev.off()
```
...
t<-read.table(infile)
names(t)<-c("sid","te","smtype","strand","quatsch","coverage","order","matrix")
t<-subset(t,te=="QUASIMODO" & smtype=="piRNA" & sid %in% c("R1-G35","R2-G35","R4-G35"))
...
plot(p)
pdf(file="/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06.2-U-bias-family/graph/quasi_main_g35.pdf",width=7,height=4)
plot(p)
dev.off()
```
