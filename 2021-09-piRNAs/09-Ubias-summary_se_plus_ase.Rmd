---
title: "small-RNA-motif-sumsease"
...
Small RNA motifs, summarizing over sense and antisense transcripts


# preprocess
```{bash eval=FALSE}
source ~/.zshrc 
script="/Users/rokofler/dev/te-tools/ere/smallRNA-U-bias-sumsease.py"
mi=23
ma=29
inf="/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/raw-bam"
ouf="/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/08-Ubias-summary/rawdata"
...
library(ggseqlogo)
library(tidyverse)
infile<-"/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/08-Ubias-summary/rawdata/for.R"
t<-read.table(infile)
names(t)<-c("sid","smtype","te","coverage","order","matrix")
t<-subset(t,te=="P")
...
active_smtype<-"piRNA"
ts<-subset(t,smtype==active_smtype)
...
infile<-paste0("/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/08-Ubias-summary/graphs/",active_smtype,".pdf")  
