...
```{bash eval=FALSE}
source ~/.zshrc 
# NOTE: the size of the small RNAs 23-29 is hard coded into this script!
script="/Users/rokofler/dev/te-tools/ere/smallRNA-U-bias.py"
mi=23
ma=29
inf="/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/raw-bam"
ouf="/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06-U-bias/rawdata"
...
infile<-"/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06-U-bias/rawdata/for.R"
t<-read.table(infile)
names(t)<-c("sid","smtype","strand","te","coverage","order","matrix")
t<-subset(t,te=="P")
...
infile<-paste0("/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06-U-bias/graphs/",active_smtype,"_",active_strand,".pdf")  
...
t<-read.table(infile)
names(t)<-c("sid","smtype","strand","te","coverage","order","matrix")
t<-subset(t,te=="P" & smtype=="piRNA" & sid %in% c("R1-G30","R2-G30","R4-G30"))
...
pdf(file="/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06-U-bias/graphs/main-g30.pdf",width=7,height=4)
plot(p)
dev.off()
```
...
t<-read.table(infile)
names(t)<-c("sid","smtype","strand","te","coverage","order","matrix")
t<-subset(t,te=="P" & smtype=="piRNA" & sid %in% c("R1-G35","R2-G35","R4-G35"))
...
pdf(file="/Users/rokofler/analysis/2021-Dere-Pele/analysis/2021-09-piRNAs/06-U-bias/graphs/main-g35.pdf",width=7,height=4)
plot(p)
dev.off()
```
